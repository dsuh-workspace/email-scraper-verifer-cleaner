...
| Sacramento & Capital Region | HVAC & Plumbing | 2026-08-20 | Outscraper 7-Stage End-to-End Ingest (Run 100) | **Done** | Ingested Phase 1 Sacramento & Capital Region batch (Sacramento, Roseville, Elk Grove, Folsom, Rocklin, Davis, Citrus Heights, Rancho Cordova). 651 raw listings fetched, 418 net-new businesses, 427 Tomba decision makers, 417 verified emails, 145 phone classification calls. 369 verified prospects mapped into Saleshandy sequences via live API. |
